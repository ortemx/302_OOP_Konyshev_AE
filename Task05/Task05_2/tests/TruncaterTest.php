...
class TruncaterTest extends TestCase
{
    public function testTruncate()
    {
        ...
        $this->assertSame("Конышев Ар...", $defaultTruncater->truncate(
            "Конышев Артем Евгеньевич",
            ['length' => 10]
        ));
        $this->assertSame("Конышев Артем ...", $defaultTruncater->truncate(
            "Конышев Артем Евгеньевич",
            ['length' => -10]
        ));
        $this->assertSame("Конышев Ар*", $defaultTruncater->truncate(
        ...
        $this->assertSame("Конышев Артем \\", $overriddenTruncater1->truncate(
            "Конышев Артем Евгеньевич",
            ['separator' => '\\']
        ));
